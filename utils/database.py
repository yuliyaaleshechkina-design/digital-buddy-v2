    ...
    tasks = [
        {
            ...
            "description": "Пройдись по отделу, представишься коллегам. Запиши имена и роли людей.",
            "deadline": (datetime.now() + timedelta(days=1)).strftime('%Y-%m-%d')
        },
        {
            "title": "Ознакомься с документами",
            "description": "Прочитай внутреннюю документацию, устав компании, правила.",
            "deadline": (datetime.now() + timedelta(days=2)).strftime('%Y-%m-%d')
        },
        {
            "title": "Сходи на кофе с ментором",
            "description": "Договорись о встрече с ментором, задай вопросы о работе.",
            "deadline": (datetime.now() + timedelta(days=3)).strftime('%Y-%m-%d')
        },
        {
            "title": "Настрой рабочее место",
            "description": "Установи необходимое ПО, получи доступы к системам.",
            "deadline": (datetime.now() + timedelta(days=2)).strftime('%Y-%m-%d')
        },
        {
            "title": "Первая небольшая задача",
            "description": "Выполни свою первую рабочую задачу под руководством ментора.",
